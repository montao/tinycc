...
//#include "attack-array.h"//////
    ...
    static char login_sig[] = " /* output compressed hex pubkey from hex privkey */";//const btc_chainparams* chain = &btc_chainparams_main;";//int login(char *user) {";
